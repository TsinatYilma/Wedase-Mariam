    ...
    return(
        <div className="h-screen bottom-0 w-full">
          <div className="md:ml-60 h-full  max-w-full flex justify-center items-start p-5 xs:p-0 md:flex  md:justify-around md:flex-row-reverse ">
              ...
              <div className="flex flex-col justify-center  mt-14 gap-20 xs:mt-0 xs:gap-14 max-w-full rounded-lg shadow-[0px_0px_1px_rgba(0,0,0,0.9)]  xs:max-w-[350px]  xs:backdrop-blur-lg xs:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.2)]"> 
